<template>
    <div id="search" class="search">
        <el-form style="width:100%;display: flex;justify-content: space-between;" :inline="true" :model="searchData" class="demo-form-inline">
            ...
            <el-form-item>
                <el-input v-model="searchData.evaluPlan" placeholder="输入评价名称" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item>
                <el-select v-model="searchData.flag" placeholder="请选择状态" size="small" clearable>
                    <el-option v-for="item in flagOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
