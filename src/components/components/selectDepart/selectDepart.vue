<template>
    <el-dialog id="selectDepart" title="部门选择" :visible="visible" @close="close" :modal=false width="30%">
        <div class="head-area">
            <el-form ref="form" :inline="true">
                <el-form-item>
                    <el-input v-model="searchData.id" placeholder="输入部门编号" size="small" style="width:200px;" clearable></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-table ref="departTable" :data="tableData" :row-style="{cursor:'pointer'}" border fit 
    ...
    methods:{
        ...
        getData(){
            let requestParams = {
                ...
                method: 'GET',
                headers: {
                    'JSESSIONID':'31889B092D96475319A48AAAA08CEADA',
                    'io':'b7ekeBihabMR__zIAAQz'
                }
            }
            request(requestParams).then((res) => {
                if(res.status == 200){
